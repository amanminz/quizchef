...
- [RFC-005 Realtime Protocol](RFC-005-websocket-protocol.md) — **Accepted** (protocol + transport foundation implemented; command handling/gameplay projections follow)
