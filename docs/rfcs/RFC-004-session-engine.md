...
* ParticipantConnection model (active transport, reconnect, heartbeat, disconnect — deliberately not "presence")
* Domain events (QuestionStartedEvent, ParticipantJoinedEvent, ParticipantReconnectedEvent, AnswerSubmittedEvent, LeaderboardUpdatedEvent, SessionCompletedEvent)
